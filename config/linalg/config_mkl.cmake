if( USE_MKL )
    ...
    if( BELFEM_COMPILER STREQUAL "GCC")
        set( APPEND BELFEM_MATRIX_LIBS "-Wl,--start-group ${BELFEM_MATRIX_LIBS} -Wl,--end-group" )
    endif()

    # add scalapack
    if( USE_MKL_64BIT_API )
        set( APPEND BELFEM_MATRIX_LIBS "${BELFEM_MKL_LIBDIR}/libmkl_scalapack_ilp64.a ${BELFEM_MATRIX_LIBS}" )
    else()
        set( APPEND BELFEM_MATRIX_LIBS "${BELFEM_MKL_LIBDIR}/libmkl_scalapack_lp64.a ${BELFEM_MATRIX_LIBS}" )
    endif()
    ...
    set( APPEND BELFEM_MATRIX_LIBS "${BELFEM_MATRIX_LIBS} -lpthread -lm -ldl" )
else()
    list( APPEND BELFEM_DEFS "BELFEM_NETLIB" )
    if( USE_MPI )
        set( BELFEM_MATRIX_LIBS "-lscalapack -llapack -lfspblas -lcblas -lblas")
    else()
