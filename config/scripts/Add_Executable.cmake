...
if ( USE_PROFILER )
    target_link_libraries( ${EXECNAME} ${BELFEM_LIBS} ${BELFEM_IO_LIBS} ${BELFEM_SOLVER_LIBS} ${BELFEM_MATRIX_LIBS} ${BELFEM_PERFORMANCELIBS} ${BELFEM_FORTRANLIBS} ${BELFEM_OPENMPLIBS} )
else()
    target_link_libraries( ${EXECNAME} ${BELFEM_LIBS} ${BELFEM_IO_LIBS} ${BELFEM_SOLVER_LIBS} ${BELFEM_MATRIX_LIBS} ${BELFEM_FORTRANLIBS} ${BELFEM_OPENMPLIBS} )
endif()
