          ...
          char * argv[] )
{
    ...
    print_banner( "mixed h-ɸ/T electromagmetic-thermal simulation");
    ...
    ThermalFactory tTFactory( tFile, tKernel.get() ) ;

    auto tKernel2 = tTFactory.create_thermal_kernel() ;
