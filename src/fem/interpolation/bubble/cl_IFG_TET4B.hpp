...
//------------------------------------------------------------------------------
    	 ...
    	 /**
    	 *  Bubble function for TET4 element, side 1,
    	 *  following the EXODUSII numbering scheme
    	 * \f{align}{ N & = 27 \, \eta \, \zeta \, ( 1 - \eta - \zeta ) \f}.
    	 */
...
//------------------------------------------------------------------------------
        ...
        InterpolationFunctionTemplate<
                GeometryType::TET, InterpolationType::BubbleFace1, 3, 1 >
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TET, InterpolationType::BubbleFace1, 3, 1 >::N(
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TET, InterpolationType::BubbleFace1, 3, 1 >::dNdXi(
                const Vector <real> & aXi,
                Matrix <real> & adNdXi ) const
        {
            ...
            adNdXi.set_size( 3, 1 );
            adNdXi( 0, 0 ) = 0.0 ;  // dN/dxi
            adNdXi( 1, 0 ) = 27. * zeta * ( 1. - 2.*eta - zeta) ;   // dN/deta
            adNdXi( 2, 0 ) = 27. * eta * ( 1. - eta - 2.*zeta );  // dN/dzeta
        }
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TET, InterpolationType::BubbleFace1, 3, 1 >::d2NdXi2(
                const Vector <real> & aXi,
