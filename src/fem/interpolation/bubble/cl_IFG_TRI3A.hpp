...
//------------------------------------------------------------------------------
    	/**
    	 * Bubble function for TRI3 element, side 0
    	 * \f$4\,\xi \,\eta\f$
    	 */
//------------------------------------------------------------------------------
        ...
        InterpolationFunctionTemplate<
                GeometryType::TRI, InterpolationType::BubbleEdge0, 2, 1 >
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TRI, InterpolationType::BubbleEdge0, 2, 1 >::N(
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TRI, InterpolationType::BubbleEdge0, 2, 1 >::dNdXi(
                const Vector <real> & aXi,
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::TRI, InterpolationType::BubbleEdge0, 2, 1 >::d2NdXi2(
                const Vector <real> & aXi,
