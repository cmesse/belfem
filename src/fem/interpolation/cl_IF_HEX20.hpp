...
#ifndef BELFEM_CL_IF_HEX20_HPP
#define BELFEM_CL_IF_HEX20_HPP
...
//------------------------------------------------------------------------------
        ...
        InterpolationFunctionTemplate<
                GeometryType::HEX, InterpolationType::LAGRANGE, 3, 20 >
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::HEX, InterpolationType::LAGRANGE, 3, 20 >::N(
                ...
                Matrix< real > & aN  ) const
        {
            ...
            aN( 0,  0 ) =   ( eta - 1.0 ) * ( xi - 1.0 ) * ( zeta - 1.0 ) * ( eta + xi + zeta + 2.0 ) * 0.125;
            aN( 0,  1 ) = - ( eta - 1.0 ) * ( xi + 1.0 ) * ( zeta - 1.0 ) * ( eta - xi + zeta + 2.0 ) * 0.125;
            aN( 0,  2 ) = - ( eta + 1.0 ) * ( xi + 1.0 ) * ( zeta - 1.0 ) * ( eta + xi - zeta - 2.0 ) * 0.125;
            aN( 0,  3 ) = - ( eta + 1.0 ) * ( xi - 1.0 ) * ( zeta - 1.0 ) * (  - eta + xi + zeta + 2.0 ) * 0.125;
            aN( 0,  4 ) = - ( eta - 1.0 ) * ( xi - 1.0 ) * ( zeta + 1.0 ) * ( eta + xi - zeta + 2.0 ) * 0.125;
            aN( 0,  5 ) =   ( eta - 1.0 ) * ( xi + 1.0 ) * ( zeta + 1.0 ) * ( eta - xi - zeta + 2.0 ) * 0.125;
            aN( 0,  6 ) =   ( eta + 1.0 ) * ( xi + 1.0 ) * ( zeta + 1.0 ) * ( eta + xi + zeta - 2.0 ) * 0.125;
            aN( 0,  7 ) = - ( eta + 1.0 ) * ( xi - 1.0 ) * ( zeta + 1.0 ) * ( eta - xi + zeta - 2.0 ) * 0.125;
            aN( 0,  8 ) = - ( xi2 - 1.0 ) * ( eta - 1.0 ) * ( zeta - 1.0 ) * 0.25;
            aN( 0,  9 ) =   ( eta2 - 1.0 ) * ( xi + 1.0 ) * ( zeta - 1.0 ) * 0.25;
            aN( 0, 10 ) =   ( xi2 - 1.0 ) * ( eta + 1.0 ) * ( zeta - 1.0 ) * 0.25;
            aN( 0, 11 ) = - ( eta2 - 1.0 ) * ( xi - 1.0 ) * ( zeta - 1.0 ) * 0.25;
            aN( 0, 12 ) = - ( zeta2- 1.0 ) * ( eta - 1.0 ) * ( xi - 1.0 ) * 0.25;
            aN( 0, 13 ) =   ( zeta2- 1.0 ) * ( eta - 1.0 ) * ( xi + 1.0 ) * 0.25;
            aN( 0, 14 ) = - ( zeta2- 1.0 ) * ( eta + 1.0 ) * ( xi + 1.0 ) * 0.25;
            aN( 0, 15 ) =   ( zeta2- 1.0 ) * ( eta + 1.0 ) * ( xi - 1.0 ) * 0.25;
            aN( 0, 16 ) =   ( xi2 - 1.0 ) * ( eta - 1.0 ) * ( zeta + 1.0 ) * 0.25;
            aN( 0, 17 ) = - ( eta2 - 1.0 ) * ( xi + 1.0 ) * ( zeta + 1.0 ) * 0.25;
            aN( 0, 18 ) = - ( xi2 - 1.0 ) * ( eta + 1.0 ) * ( zeta + 1.0 ) * 0.25;
            aN( 0, 19 ) =   ( eta2 - 1.0 ) * ( xi - 1.0 ) * ( zeta + 1.0 ) * 0.25;
        }
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::HEX, InterpolationType::LAGRANGE, 3, 20 >::dNdXi(
                const Vector< real > & aXi,
...
//------------------------------------------------------------------------------
        ...
        void
        InterpolationFunctionTemplate<
                GeometryType::HEX, InterpolationType::LAGRANGE, 3, 20 >::d2NdXi2(
                const Vector< real > & aXi,
