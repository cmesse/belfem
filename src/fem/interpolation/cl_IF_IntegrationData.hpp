...
namespace belfem
{
    ...
    {
        /**
         * @brief Precomputed bundle of integration points, weights and shape-function values.
         *
...
//------------------------------------------------------------------------------
             ...
             */
            void
            populate( const uint aIntegrationOrder=0,
