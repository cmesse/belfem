...
//------------------------------------------------------------------------------
                ...
                Matrix< real > & aN  ) const
        {
            ...
            aN( 0,  1 ) = (eta*(9.0*eta*(eta-1.0)+2.0)) * 0.5;
            aN( 0,  2 ) = (zeta*(9.0*zeta*(zeta-1.0) + 2.0)) * 0.5;
            aN( 0,  3 ) = 0.5 * tau*( psi-2.0 )*( psi-1.0 );
            aN( 0,  4 ) = 4.5*eta*xi*(3.0*xi-1.0);
            aN( 0,  5 ) = 4.5*eta*xi*(3.0*eta-1.0);
            aN( 0,  6 )  = 4.5*eta*zeta*(3.0*eta-1.0);
            aN( 0,  7 )  = 4.5*eta*zeta*(3.0*zeta-1.0);
            aN( 0,  8 )  = 4.5*xi*zeta*(3.0*zeta-1.0);
            aN( 0,  9 ) = 4.5*xi*zeta*(3.0*xi-1.0);
            aN( 0, 10 ) = 4.5*xi*tau*( 2.0-psi );
            aN( 0, 11 ) = 4.5*xi*(3.0*xi-1.0)*tau;
            aN( 0, 12 ) = 4.5*zeta*tau*(2.0-psi);
            aN( 0, 13 ) = 4.5*zeta*(3.0*zeta-1.0)*tau;
            aN( 0, 14 ) = 4.5*eta*tau*(2.0-psi);
            aN( 0, 15 ) = 4.5*eta*(3.0*eta-1.0)*tau;
            aN( 0, 16 ) = 27.0*xi*eta*zeta;
            aN( 0, 17 ) = 27.0*xi*eta*tau;
            aN( 0, 18 ) = 27.0*xi*zeta*tau;
...
//------------------------------------------------------------------------------
                ...
                Matrix< real > & adNdXi  ) const
        {
            ...
            adNdXi( 0,  2 ) = 0.0;
            adNdXi( 1,  2 ) = 0.0;
            adNdXi( 2,  2 ) = 1.0+zeta*(13.5*zeta-9.0);
            ...
            adNdXi( 0,  4 ) = eta*(27.0*xi-4.5);
            adNdXi( 1,  4 ) = xi*(13.5*xi-4.5);
            adNdXi( 2,  4 ) = 0.0;

            adNdXi( 0,  5 ) = eta*(13.5*eta-4.5);
            adNdXi( 1,  5 ) = xi*(27.0*eta-4.5);
            adNdXi( 2,  5 ) = 0.0;

            adNdXi( 0,  6 ) = 0.0;
            adNdXi( 1,  6 ) = zeta*(27.0*eta-4.5);
            adNdXi( 2,  6 ) = eta*(13.5*eta-4.5);

            adNdXi( 0,  7 ) = 0.0;
            adNdXi( 1,  7 ) = zeta*(13.5*zeta-4.5);
            adNdXi( 2,  7 ) = eta*(27.0*zeta-4.5);

            adNdXi( 0,  8 ) = zeta*(13.5*zeta-4.5);
            adNdXi( 1,  8 ) = 0.0;
            adNdXi( 2,  8 ) = xi*(27.0*zeta-4.5);

            adNdXi( 0,  9 ) = zeta*(27.0*xi-4.5);
            adNdXi( 1,  9 ) = 0.0;
            adNdXi( 2,  9 ) = xi*(13.5*xi-4.5);
            ...
            adNdXi( 0, 12 ) = zeta*(27.0*(xi+eta+zeta)-22.5);
            adNdXi( 1, 12 ) = zeta*(27.0*(xi+eta+zeta)-22.5);
            adNdXi( 2, 12 ) = 9.0+13.5*(xi2+eta2)+zeta*(40.5*zeta-45.0)+xi*(54.0*zeta-22.5)+eta*(27.0*xi+54.0*zeta-22.5);

            adNdXi( 0, 13 ) = zeta*(4.5-13.5*zeta);
            adNdXi( 1, 13 ) = zeta*(4.5-13.5*zeta);
            adNdXi( 2, 13 ) = xi*(4.5-27.0*zeta)+eta*(4.5-27.0*zeta)+zeta*(36.0-40.5*zeta)-4.5;

            adNdXi( 0, 14 ) = eta*(27.0*(xi+eta+zeta)-22.5);
            adNdXi( 1, 14 ) = 9.0+40.5*eta2+13.5*xi2+xi*(27.0*zeta-22.5)+eta*(54.0*xi+54.0*zeta-45.0)+zeta*(13.5*zeta-22.5);
            adNdXi( 2, 14 ) = eta*(27.0*(xi+eta+zeta)-22.5);

            adNdXi( 0, 15 ) = eta*(4.5-13.5*eta);
            adNdXi( 1, 15 ) = 4.5*(xi+zeta)+eta*(36.0-40.5*eta-27.0*(xi+zeta))-4.5;
            adNdXi( 2, 15 ) = eta*(4.5-13.5*eta);

            adNdXi( 0, 16 ) = 27.0*eta*zeta;
            adNdXi( 1, 16 ) = 27.0*xi*zeta;
            adNdXi( 2, 16 ) = 27.0*xi*eta;

            adNdXi( 0, 17 ) = 27.0*eta*(1.0 - (eta+zeta+2.0*xi));
            adNdXi( 1, 17 ) = 27.0*xi*(1.0-(xi+2.0*eta+zeta));
            adNdXi( 2, 17 ) = -27.0*xi*eta;

            adNdXi( 0, 18 ) = 27.0*zeta*(1.0-(2.0*xi+eta+zeta));
            adNdXi( 1, 18 ) = -27.0*xi*zeta;
            adNdXi( 2, 18 ) = 27.0*xi*(1.0-(xi+eta+2.0*zeta));
...
//------------------------------------------------------------------------------
                ...
                Matrix< real > & ad2NdXi2  ) const
        {
            ...
            ad2NdXi2( 3,  4 ) = 0.0;
            ad2NdXi2( 4,  4 ) = 0.0;
            ad2NdXi2( 5,  4 ) = 27.0*xi-4.5;

            ad2NdXi2( 0,  5 ) = 0.0;
            ad2NdXi2( 1,  5 ) = 27.0*xi;
            ad2NdXi2( 2,  5 ) = 0.0;
            ad2NdXi2( 3,  5 ) = 0.0;
            ad2NdXi2( 4,  5 ) = 0.0;
            ad2NdXi2( 5,  5 ) = 27.0*eta-4.5;

            ad2NdXi2( 0,  6 ) = 0.0;
            ad2NdXi2( 1,  6 ) = 27.0*zeta;
            ad2NdXi2( 2,  6 ) = 0.0;
            ad2NdXi2( 3,  6 ) = 27.0*eta-4.5;
            ad2NdXi2( 4,  6 ) = 0.0;
            ad2NdXi2( 5,  6 ) = 0.0;

            ad2NdXi2( 0,  7 ) = 0.0;
            ad2NdXi2( 1,  7 ) = 0.0;
            ad2NdXi2( 2,  7 ) = 27.0*eta;
            ad2NdXi2( 3,  7 ) = 27.0*zeta-4.5;
            ad2NdXi2( 4,  7 ) = 0.0;
            ad2NdXi2( 5,  7 ) = 0.0;

            ad2NdXi2( 0,  8 ) = 0.0;
            ad2NdXi2( 1,  8 ) = 0.0;
            ad2NdXi2( 2,  8 ) = 27.0*xi;
            ad2NdXi2( 3,  8 ) = 0.0;
            ad2NdXi2( 4,  8 ) = 27.0*zeta-4.5;
            ad2NdXi2( 5,  8 ) = 0.0;

            ad2NdXi2( 0,  9 ) = 27.0*zeta;
            ad2NdXi2( 1,  9 ) = 0.0;
            ad2NdXi2( 2,  9 ) = 0.0;
            ad2NdXi2( 3,  9 ) = 0.0;
            ad2NdXi2( 4,  9 ) = 27.0*xi-4.5;
            ad2NdXi2( 5,  9 ) = 0.0;
            ...
            ad2NdXi2( 0, 12 ) = 27.0*zeta;
            ad2NdXi2( 1, 12 ) = 27.0*zeta;
            ad2NdXi2( 2, 12 ) = 54.0*(xi+eta)+81.0*zeta-45.0;
            ad2NdXi2( 3, 12 ) = 27.0*(xi+eta)+54.0*zeta-22.5;
            ad2NdXi2( 4, 12 ) = 27.0*(xi+eta)+54.0*zeta-22.5;
            ad2NdXi2( 5, 12 ) = 27.0*zeta;

            ad2NdXi2( 0, 13 ) = 0.0;
            ad2NdXi2( 1, 13 ) = 0.0;
            ad2NdXi2( 2, 13 ) = 36.0-27.0*(xi+eta)-81.0*zeta;
            ad2NdXi2( 3, 13 ) = 4.5-27.0*zeta;
            ad2NdXi2( 4, 13 ) = 4.5-27.0*zeta;
            ad2NdXi2( 5, 13 ) = 0.0;

            ad2NdXi2( 0, 14 ) = 27.0*eta;
            ad2NdXi2( 1, 14 ) = 54.0*(xi+zeta)+81.0*eta-45.0;
            ad2NdXi2( 2, 14 ) = 27.0*eta;
            ad2NdXi2( 3, 14 ) = 27.0*(xi+zeta)+54.0*eta-22.5;
            ad2NdXi2( 4, 14 ) = 27.0*eta;
            ad2NdXi2( 5, 14 ) = 27.0*(xi+zeta)+54.0*eta-22.5;

            ad2NdXi2( 0, 15 ) = 0.0;
            ad2NdXi2( 1, 15 ) = 36.0-27.0*(xi+zeta)-81.0*eta;
            ad2NdXi2( 2, 15 ) = 0.0;
            ad2NdXi2( 3, 15 ) = 4.5-27.0*eta;
            ad2NdXi2( 4, 15 ) = 0.0;
            ad2NdXi2( 5, 15 ) = 4.5-27.0*eta;
            ...
            ad2NdXi2( 0, 17 ) = -54.0*eta;
            ad2NdXi2( 1, 17 ) = -54.0*xi;
            ad2NdXi2( 2, 17 ) = 0.0;
            ad2NdXi2( 3, 17 ) = -27.0*xi;
            ad2NdXi2( 4, 17 ) = -27.0*eta;
            ad2NdXi2( 5, 17 ) = 27.0-54.0*(xi+eta)-27.0*zeta;

            ad2NdXi2( 0, 18 ) = -54.0*zeta;
            ad2NdXi2( 1, 18 ) = 0.0;
            ad2NdXi2( 2, 18 ) = -54.0*xi;
            ad2NdXi2( 3, 18 ) = -27.0*xi;
            ad2NdXi2( 4, 18 ) = 27.0-54.0*(xi+zeta)-27.0*eta;
            ad2NdXi2( 5, 18 ) = -27.0*zeta;
