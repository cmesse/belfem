...
//------------------------------------------------------------------------------
                      ...
                      Matrix< real > & aN  ) const
        {
            ...
            aN( 0, 3 ) = 4.5*eta*xi*(3.0*xi-1.0);

            aN( 0, 4 ) = 4.5*eta*xi*(3.0*eta-1.0);

            aN( 0, 5 ) = 4.5*zeta*eta*(3.0*eta-1.0);

            aN( 0, 6 ) = 4.5*eta*((3.0*(xi+eta)-5.0)*(xi+eta)+2.0);
...
//------------------------------------------------------------------------------
                ...
                Matrix< real > & adNdXi  ) const
        {
            ...
            adNdXi(0,3)=eta*(27.*xi-4.5);
            adNdXi(1,3)=xi*(13.5*xi-4.5);

            adNdXi(0,4)=eta*(13.5*eta-4.5);
            adNdXi(1,4)=xi*(27.0*eta-4.5);

            adNdXi(0,5)=(4.5-13.5*eta)*eta;
            adNdXi(1,5)=eta*(36.0-40.5*eta-27.0*xi)+4.5*xi-4.5;

            adNdXi(0,6)=eta*(27.0*(eta+xi)-22.5);
            adNdXi(1,6)=9.0+eta*(40.5*eta+54.0*xi-45.0)+xi*(13.5*xi-22.5);
...
//------------------------------------------------------------------------------
                ...
                Matrix< real > & ad2NdXi2  ) const
        {
            ...
            ad2NdXi2(0,3)=27.0*eta;
            ad2NdXi2(1,3)=0.0;
            ad2NdXi2(2,3)=27.0*xi-4.5;

            ad2NdXi2(0,4)=0.0;
            ad2NdXi2(1,4)=27.0*xi;
            ad2NdXi2(2,4)=27.0*eta-4.5;

            ad2NdXi2(0,5)=0.0;
            ad2NdXi2(1,5)=36.0-81.0*eta-27.0*xi;
            ad2NdXi2(2,5)=4.5-27.0*eta;

            ad2NdXi2(0,6)=27.0*eta;
            ad2NdXi2(1,6)=54.0*xi+81.0*eta-45.0;
            ad2NdXi2(2,6)=27.0*xi+54.0*eta-22.5;
