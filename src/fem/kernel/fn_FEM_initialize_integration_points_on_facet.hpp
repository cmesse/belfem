...
#ifndef BELFEM_FN_FEM_INITIALIZE_INTEGRATION_POINTS_ON_FACET_HPP
#define BELFEM_FN_FEM_INITIALIZE_INTEGRATION_POINTS_ON_FACET_HPP
...
#endif //BELFEM_FN_FEM_INITIALIZE_INTEGRATION_POINTS_ON_FACET_HPP
