...
#ifndef BELFEM_CL_IWG_MAXWELL_HA2D_HPP
#define BELFEM_CL_IWG_MAXWELL_HA2D_HPP
...
namespace belfem
{
    namespace fem
    {
        class IWG_Maxwell_HA2D : public IWG_Maxwell_Old
        {

            void
            ( IWG_Maxwell_HA2D::*mFunJacobian )
                    (       Element        * aElement,
...
//------------------------------------------------------------------------------
        ...
        inline void
        IWG_Maxwell_HA2D::compute_jacobian_and_rhs(
                Element        * aElement,
                Matrix< real > & aJacobian,
                Vector< real > & aRHS )
        {
...
#endif //BELFEM_CL_IWG_MAXWELL_HA2D_HPP
