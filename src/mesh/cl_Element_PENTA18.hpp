...
//------------------------------------------------------------------------------
        ...
        template <>
        ElementType
        LagrangeElement< 18, 6, 9, 5, 5 >::type() const
        {
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        LagrangeElement< 18, 6, 9, 5, 5 >::get_nodes_of_facet( const uint aFacetIndex, Cell< Node * > & aNodes )
        {
            switch( aFacetIndex )
            {
                case( 0 ):
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        LagrangeElement< 18, 6, 9, 5, 5 >::get_edges_of_facet(
