...
//------------------------------------------------------------------------------
        ...
        template <>
        ElementType
        ElementTemplate< 8, 4, 4, 4, 1 >::type() const
        {
...
//------------------------------------------------------------------------------
        ...
        template <>
        uint
        ElementTemplate< 8, 4, 4, 4, 1 >::dimension() const
        {
            return 2 ;
        }
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 8, 4, 4, 4, 1 >::get_nodes_of_facet( const uint aFacetIndex, Cell< Node * > & aNodes )
        {
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 8, 4, 4, 4, 1 >::get_corner_nodes_of_facet( const uint aFacetIndex, Cell< Node * > & aNodes )
        {
            // allocate the node container
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 8, 4, 4, 4, 1 >::get_edges_of_facet(
