...
//------------------------------------------------------------------------------
        ...
        template <>
        ElementType
        ElementTemplate< 6, 3, 3, 3, 1 >::type() const
        {
...
//------------------------------------------------------------------------------
        ...
        template <>
        uint
        ElementTemplate< 6, 3, 3, 3, 1 >::dimension() const
        {
            return 2 ;
        }
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 6, 3, 3, 3, 1 >::get_nodes_of_facet( const uint aFacetIndex, Cell< Node * > & aNodes )
        {
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 6, 3, 3, 3, 1 >::get_corner_nodes_of_facet( const uint aFacetIndex, Cell< Node * > & aNodes )
        {
            // allocate the node container
...
//------------------------------------------------------------------------------
        ...
        template <>
        void
        ElementTemplate< 6, 3, 3, 3, 1 >::get_edges_of_facet(
