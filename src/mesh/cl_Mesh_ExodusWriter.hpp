...
namespace belfem
{
    namespace mesh
    {
        class ExodusWriter
        {
            ...
            //! blocks that go into the file: nonempty only, sorted by id.
            //! header counts, definitions, connectivity and field tables
            //! must all use this list so the file stays consistent
            Cell< Block * > mBlocks ;
