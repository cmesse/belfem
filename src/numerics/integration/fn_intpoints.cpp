...
// Felippa
#include "fn_intpoints_gauss_pyra1.hpp"
#include "fn_intpoints_gauss_pyra8.hpp"
#include "fn_intpoints_gauss_pyra27.hpp"
#include "fn_intpoints_gauss_pyra64.hpp"
#include "fn_intpoints_gauss_pyra125.hpp"
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                        switch ( aOrder )
                        {
                            ...
                            default:
                            {
                                BELFEM_ERROR( false, "Invalid Order for GeometryType::PENTA" );
                                break;
                            }
                        }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                        switch ( aOrder )
                        {
                            ...
                            case ( 8 ) :
                            {
                                // Witherden and Vincent, exact through degree 8.
                                // The Shunn and Ham 35-point table is exact only
                                // through degree 6 ( its "7th order" is the paper's
                                // delta^7 leading-error numbering ), and Keast's
                                // 31-point degree-7 rule carries a four-point orbit
                                // of negative weights ( -0.0625 each against 1/6 )
                            ...
                            case ( 10 ) :
                            {
                                // Witherden and Vincent, exact through degree 10.
                                // The Shunn and Ham 56-point table is exact only
                                // through degree 8 ( "9th order" = delta^9 )
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                    ...
                    {
                        // conical-product rules, exact through degree 2n-1 for
                        // n^3 points ( pyra8 = 3, pyra27 = 5, pyra64 = 7, pyra125 = 9 )
                        switch ( aOrder )
                        {
                            case ( 0 ) :
                            case ( 1 ) :
                            {
                                integration::gauss_pyra1( aWeights, aPoints );
                                break;
                            }
                            case ( 2 ) :
                            case ( 3 ) :
                            {
                                integration::gauss_pyra8( aWeights, aPoints );
                                break;
                            }
                            case ( 4 ) :
                            case ( 5 ) :
                            {
                                integration::gauss_pyra27( aWeights, aPoints );
                                break;
                            }
                            case ( 6 ) :
                            case ( 7 ) :
                            {
                                integration::gauss_pyra64( aWeights, aPoints );
                                break;
                            }
                            case ( 8 ) :
                            case ( 9 ) :
                            {
                                integration::gauss_pyra125( aWeights, aPoints );
                                break;
                            }
                            default:
                            {
                                BELFEM_ERROR( false, "Invalid Order for GeometryType::PYRA" );
                                break;
                            }
                        }
                        break;
                    } // end geometry type pyra
                    default :
                    {
                        BELFEM_ERROR( false, "Invalid geometry type" );
                        break;
