...
//----------------------------------------------------------------------------
        ...
        AlphaFunctionFactory::create_srk( const gastables::GasData * aData )
        {
            ...
            // calculate M
            // 10.1016/0009-2509(72)80096-4, Eq. ( 15 )
...
//----------------------------------------------------------------------------
        ...
        AlphaFunctionFactory::create_pr78( const gastables::GasData * aData )
        {
            ...
            // 1978 update; the published pair has a small jump ( +0.0055 in m )
            // at the switch, which we keep to stay with the literature values
            if( tOmega <= 0.491 )
            {
            ...
            {
                tM = 0.379642 + ( 1.487503 + ( 0.016666*tOmega - 0.164423 ) *tOmega ) * tOmega;
            }
...
//----------------------------------------------------------------------------
        ...
        AlphaFunctionFactory::create_ccr_mc_srk( const gastables::GasData * aData )
        {
            ...
            else
            {
                ...
                // Equation ( 14 )
                tC1 = ( 1.6054 - 0.1094 * tOmega  ) * tOmega + 0.5178;
