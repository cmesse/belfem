...
//----------------------------------------------------------------------------
        ...
        {
            mD = { 1 , 4 , 1 , 1 , 2 , 2 , 3 , 1 , 3 , 2 , 1 , 3 , 1 , 1 };
            switch ( aModel )
            {
            ...
            // validity range, Leachman et al. 2009
            mTmax = 1000.0 ;
            mPmax = 2000.0e6 ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phi0() const
        {
            this->update_e() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir() const
        {
            this->update_f();
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phi0_t() const
        {
            this->update_e() ;

            // first tau derivative of equation (31)
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phi0_tt() const
        {
            this->update_e() ;

            // second tau derivative of equation (31)
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir_d() const
        {
            this->update_f();
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir_dd() const
        {
            this->update_f();
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir_t() const
        {
            this->update_f();
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir_tt() const
        {
            this->update_f();
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Hydrogen::compute_phir_dt() const
        {
            this->update_f();
            this->update_g() ;
