...
//----------------------------------------------------------------------------
        ...
        {
            // triple point, Schmidt & Wagner p. 181
            mTtriple = 54.361 ;
            ...
            // validity range: the p,rho,T data behind the fit end at 300 K
            // and 818 bar ( Schmidt & Wagner, abstract )
            mTmax = 300.0 ;
            mPmax = 81.8e6 ;
            ...
            /* values for ideal gas function, Schmidt & Wagner Table 3.
             * The paper fits with R = 8.31434 J/(mol K); we evaluate with the
             * CODATA value, 1.5e-5 relative — far below the EoS uncertainty */
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phi0() const
        {
            this->update_e() ;

            // Schmidt & Wagner Eq. ( 15 )
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phi0_t() const
        {
            this->update_e() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phi0_tt() const
        {
            this->update_e() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phir_d() const
        {
            this->update_f() ;
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phir_dd() const
        {
            this->update_f() ;
            this->update_g() ;
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phir_t() const
        {
            this->update_f();
            this->update_g();
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phir_tt() const
        {
            this->update_f();
            this->update_g();
...
//----------------------------------------------------------------------------
        ...
        real
        EoS_Oxygen::compute_phir_dt() const
        {
            this->update_f();
            this->update_g();
