...
//------------------------------------------------------------------------------
        ...
        /**
         * The per species property record: the scalar data that describe a gas
         * but do not depend on the state.
         *
         * Three tables feed it. thermo.inp supplies the label and the molar
         * mass; gasdata.inp adds the critical point, the acentric factor, the
         * dipole moment and the CAS number; cubicalpha.inp adds the fitted
         * alpha function coefficients for the cubic equations of state, keyed
         * on that CAS number.
         *
         * has_crit() is the gate for every real gas path - it is true only when
         * the full set T_crit, p_crit, Z_crit, acentric and dipole is present,
         * so a species missing any one of them stays ideal gas. has_cubic()
         * likewise reports whether the alpha function coefficients were found.
         *
         * Units are SI throughout even where the source file is not: molar mass
         * in kg/mol ( the file is g/mol ), critical pressure in Pa ( the file is
         * bar ), dipole moment in debye.
         *
        ...
        class GasData
        {
            ...
            friend InputData;
            friend InputAlpha;
            friend class gasmodels::Helmholtz ;
