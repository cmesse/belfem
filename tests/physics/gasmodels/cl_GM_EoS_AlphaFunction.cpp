...
// DISABLED: the second derivative checks compare an analytic d2alpha/dT2
// against the second derivative of a cubic spline through the expected values,
// and reach r2 = 0.66 to 0.73 against a required 0.99. A cubic spline's second
// derivative is only piecewise linear, so it is a weak reference; whether the
// analytic derivative or the comparison is at fault has not been established.
TEST( GASMODELS, DISABLED_AlphaFunction )
{
