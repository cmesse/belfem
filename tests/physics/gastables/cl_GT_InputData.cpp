...
TEST( GASTABLES, input_data )
{
    ...
    // 1.19 D, not the 1.1 the private table carried: that row truncated the
    // dipole instead of rounding it, as it also did for water and hydrogen
    // sulphide. Every other field of this record is unchanged.
    EXPECT_NEAR( tData->dipole(), 1.19, tEpsilon );
